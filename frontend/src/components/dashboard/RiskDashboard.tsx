  ...
  return (
    <div className="rounded-xl border border-border bg-[var(--panel)]">
      ...
      <div className="flex items-center justify-between border-b border-border px-4 py-3">
        ...
        {/* Regime badge */}
        <div className={cn(
          "flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-label font-medium",
      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-label uppercase tracking-wider text-muted-foreground font-medium">Portfolio Exposure</span>
          ...
          <div className="flex items-center gap-3 mt-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-label text-muted-foreground">Long {(metrics.longExposure ?? 0).toFixed(0)}%</span>
            </div>
            <div className="flex items-center gap-1">
              <div className="h-1.5 w-1.5 rounded-full bg-[var(--neutral)]/40" />
              <span className="text-label text-muted-foreground">Cash {(metrics.cashPct ?? 0).toFixed(0)}%</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-lg border border-border bg-[var(--surface)] px-3 py-2">
            ...
            {positions.length > 0 && (
              <p className="text-label text-muted-foreground truncate">{metrics.maxPosSymbol}</p>
            )}
          </div>
          ...
          <div className="rounded-lg border border-border bg-[var(--surface)] px-3 py-2">
            ...
            {positions.length > 0 && (
              <p className="text-label text-muted-foreground truncate">{metrics.maxSectorName}</p>
            )}
          </div>
        </div>
        ...
        {regime && (
          <div className="flex items-center justify-between pt-1 border-t border-border">
            <span className="text-label text-muted-foreground">VIX Level</span>
            <span className={cn(
