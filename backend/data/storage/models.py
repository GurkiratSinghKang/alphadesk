...
def _define_models() -> dict[str, Any]:
    ...
    class UserSettings(Base):
        ...
        trading_mode = Column(String(16), nullable=False, default="paper", server_default="paper")
        trading_mode_updated_at = Column(DateTime(timezone=True), nullable=True)
        live_step_up_at = Column(DateTime(timezone=True), nullable=True)
