  ...
  return (
    <div style={{ padding: "20px 24px 40px", maxWidth: 1640, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 20, padding: 22, border: "1px solid var(--border)", borderRadius: 4, background: "var(--ink-100)" }}>
        ...
        <div style={{ fontFamily: "var(--font-display)", fontStyle: "italic", color: "var(--fg-muted)", fontSize: 14, lineHeight: 1.55 }}>
          The strategy detail endpoint hasn't surfaced the per-stage rule set, agent assignments, or candidate / confirmation / slot-fill counters yet. Once a `/api/v1/strategies/{id}/playbook` endpoint publishes those artifacts, this section will render the rules verbatim plus today's surfaced / confirmed / live / exited numbers.
        </div>
      </div>
  ...
  return (
    <div style={{ padding: "20px 24px 40px", maxWidth: 1640, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 22, padding: 22, border: "1px solid var(--border)", borderRadius: 4, background: "var(--ink-100)" }}>
        ...
        <div style={{ fontFamily: "var(--font-display)", fontStyle: "italic", color: "var(--fg-muted)", fontSize: 14, lineHeight: 1.55 }}>
          The workbench will render run configuration, equity curve, drawdown band, and trade log here once `/api/v1/backtest/runs/{id}` returns a real run. Compare-runs and publish controls are deferred until then.
        </div>
      </div>
