      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <Badge
              variant="outline"
              className={cn("mt-0.5 text-[9px] px-1.5 py-0", RISK_COLORS[template.riskLevel])}
            >
        ...
        {isActive && (
          <Badge
            variant="outline"
            className="border-primary/40 text-primary bg-primary/10 text-[9px]"
          >
      ...
      <div className="mt-3">
        ...
        <div className="flex flex-wrap gap-1">
          {template.strategies.map((sid) => (
            <span
              key={sid}
              className="rounded-md bg-[var(--panel)] px-2 py-0.5 text-[10px] font-medium text-foreground"
            >
              {sid
                .split("-")
