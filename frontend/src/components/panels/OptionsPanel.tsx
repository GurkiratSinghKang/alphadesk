    ...
    <div data-slot="options-panel" className="flex h-full flex-col bg-[var(--panel)] border-t border-border">
      ...
      <div className="flex items-center justify-between border-b border-border px-3 py-1.5 shrink-0 bg-bg-elev-2">
        <div className="flex items-center gap-3">
          ...
          {chainData?.isDemo && (
            <Badge
              variant="outline"
              className="border-amber/50 bg-amber/10 px-1.5 py-0.5 text-label font-semibold uppercase tracking-[0.12em] text-amber"
            >
              Synthetic
            </Badge>
          )}
          ...
          <Badge
            variant="outline"
            className="text-label px-1.5 py-0.5 border-primary/50 text-primary font-semibold bg-primary/10"
          >
            IV Rank: {ivRank != null ? ivRank : "\u2014"}
          </Badge>
          <Badge
            variant="outline"
            className="text-label px-1.5 py-0.5 border-muted-foreground/40 text-foreground font-medium bg-muted-foreground/10"
          >
      ...
      {chainEmpty ? (
        <div className="flex flex-1 flex-col items-center justify-center gap-2 px-4 py-12 text-center">
          <p className="font-display italic text-body text-muted-foreground">
            Options data not available for {selectedSymbol}.
          </p>
          <p className="font-sans text-label uppercase tracking-[0.18em] text-muted-foreground/70">
            No invented quotes are shown.
          </p>
        </div>
      ) : chain == null ? null : (
        <ScrollArea className="flex-1 overflow-auto">
          <table className="w-full text-label min-w-[700px]" aria-label="Options chain">
