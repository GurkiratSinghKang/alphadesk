    ...
    <section data-slot="historical-moves" className="mt-4">
      ...
      <div className="mt-2 flex items-end gap-3">
          ...
          {historical.quarters.map((q) => {
            ...
            return (
              <div
                ...
                data-slot="hist-bar"
                data-sign={sign}
                title={`${q.reportDate}: ${(pct * 100).toFixed(1)}%`}
        ...
        <dl className="grid grid-cols-2 gap-x-4 gap-y-0.5 t-mono text-[11.5px]">
          ...
          <dd className="u-brand">±{(historical.stats.avgAbsMovePct * 100).toFixed(1)}%</dd>
          ...
          <dd>{(historical.stats.surpriseBeatRate * 100).toFixed(0)}%</dd>
          {historical.stats.ivVsHistVolPoints != null && (
            <>
              ...
              <dd className="u-muted">
                ...
                {Math.abs(historical.stats.ivVsHistVolPoints).toFixed(1)} vol pts
              </dd>
            </>
          )}
        </dl>
