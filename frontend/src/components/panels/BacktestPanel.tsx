    ...
    <div className="space-y-1">
      ...
      <div className="flex items-center gap-4 px-1">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[9px] text-muted-foreground">{result.label ?? "Strategy"}</span>
        </div>
        {benchPolyline && (
          <div className="flex items-center gap-1.5">
            <div className="h-0.5 w-4 rounded border-t border-dashed border-muted-foreground" />
            <span className="text-[9px] text-muted-foreground">SPY Buy & Hold</span>
          </div>
        )}
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          {compareMode && compareStep === "a-done" && (
            <span className="text-[10px] text-primary animate-pulse">Strategy A saved. Configure B and run again.</span>
          )}
        </div>
        {compareMode && (resultA || resultB) && (
          <button onClick={resetCompare} className="flex items-center gap-1 text-[10px] text-muted-foreground hover:text-foreground">
      ...
      {activeResult && (
        <div className="space-y-3">
          ...
          {compareMode && resultA && resultB && (
            <div>
              <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold mb-1.5">Side-by-Side Comparison</p>
