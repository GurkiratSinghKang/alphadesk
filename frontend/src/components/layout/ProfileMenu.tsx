    ...
    <>
          ...
          <div className="space-y-6 px-4 py-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="text-label text-muted-foreground">Broker API keys, preferences, and additional configuration coming soon.</p>
              </div>
            </div>
          </div>
        </SheetContent>
      ...
      <Dialog open={modeConfirmOpen} onOpenChange={setModeConfirmOpen}>
        <DialogContent className="bg-[var(--surface)] border-border">
          ...
          <DialogFooter>
            <Button onClick={handleConfirmLive} className="text-label">Got it</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      {destructive.pending && (
