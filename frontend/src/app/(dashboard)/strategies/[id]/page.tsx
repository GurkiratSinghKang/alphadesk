        ...
        <div className="space-y-4">
          ...
          {perf && (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
              ...
              />
              <MetricCard label="Sharpe Ratio" value={perf.sharpe_ratio.toFixed(2)} />
              <MetricCard label="Max Drawdown" value={`${perf.max_drawdown.toFixed(1)}%`} color="text-[var(--loss)]" />
              ...
              <MetricCard
                label="Calmar Ratio"
                value={perf.max_drawdown !== 0 ? (perf.annualized_return_pct / Math.abs(perf.max_drawdown)).toFixed(2) : "N/A"}
              />
            </div>
          )}
        </div>
