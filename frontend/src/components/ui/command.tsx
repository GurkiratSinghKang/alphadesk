...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-9! rounded-sm! border-border bg-bg-elev-1 shadow-none! *:data-[slot=input-group-addon]:pl-2!">
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "group/command-item relative flex cursor-default items-center gap-2 px-2 py-1.5 rounded-sm text-sm outline-hidden select-none",
        "in-data-[slot=dialog-content]:rounded-md!",
        "data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50",
        "data-selected:bg-bg-elev-1 data-selected:text-fg",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        "data-selected:*:[svg]:text-fg",
        className
      )}
      {...props}
    >
