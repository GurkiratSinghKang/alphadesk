...
export default function NewsFeed({ news }: NewsFeedProps) {
  ...
  return (
    <section data-slot="news-feed" className="mt-4">
      ...
      {overflow && (
        <p className="mt-0.5 t-mono text-label u-muted" data-slot="news-feed-overflow">
            ...
            >
              ...
              {a.category && (
                <span
                  ...
                  className="mr-2 inline-block rounded border border-[color:var(--brand)]/40 bg-[color:var(--brand)]/10 px-1.5 py-px text-label uppercase tracking-wider u-brand"
