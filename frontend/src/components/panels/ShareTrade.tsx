    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div className="rounded-lg bg-bg-elev-2 border border-border-hair px-3 py-2">
          <div className="text-label text-muted-foreground mb-0.5">Technical</div>
          <div className={cn(
        ...
        {data.rsi != null ? (
          <div className="rounded-lg bg-bg-elev-2 border border-border-hair px-3 py-2">
            <div className="text-label text-muted-foreground mb-0.5">RSI (14)</div>
        ...
        <div className="rounded-lg bg-bg-elev-2 border border-border-hair px-3 py-2">
          <div className="text-label text-muted-foreground mb-0.5">Volume</div>
      ...
      {data.pnl != null && (
        <div className={cn(
          ...
          <div className="flex items-center justify-between">
            <span className="text-label text-muted-foreground">Unrealized P&L</span>
            <span className={cn(
              "text-sm font-bold tabular-nums",
      ...
      <div className="flex items-center justify-between border-t border-border pt-3 mt-1">
        <div className="flex items-center gap-1.5">
          <div className="h-4 w-4 rounded bg-primary/20 flex items-center justify-center">
            <span className="text-label font-bold text-primary">A</span>
          </div>
          <span className="text-label font-medium text-muted-foreground">AlphaDesk</span>
        </div>
        <span className="text-label text-muted-foreground/60">tradingalpha.net</span>
      </div>
    </div>
  );
}
