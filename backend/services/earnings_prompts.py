...
_CONFIDENCE_CALIBRATION_PROTOCOL = (
    ...
    "  · vol_premium_score < 0.05 → ceiling 0.45 (IV ≈ realized; no harvestable edge)\n\n"
    "VOL-PREMIUM UNAVAILABLE: when vol_premium_score is null (history warming up — fewer than 4 prior earnings on file), do NOT auto-cap confidence. Fall back to iv_rank / iv_percentile alone for the vol-edge judgment. Treat IV rank >= 60 as a vol-selling tailwind comparable to vol_premium_score >= 0.15.\n\n"
