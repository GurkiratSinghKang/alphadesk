          ...
          <>
            ...
            <div className="grid grid-cols-7 gap-1 mb-1">
              {DAY_NAMES.map((d, i) => (
                <div
                  key={i}
                  className="text-center text-label font-medium text-muted-foreground py-1"
                >
                  {d}
                </div>
              ))}
                ...
                {calendarGrid.flat().map((cell, i) => {
                  ...
                  if (cell.isWeekend) {
                    return (
                      ...
                      >
                        <span className="text-label text-muted-foreground/40">{cell.day}</span>
                      </div>
                    );
                  }
                  ...
                  if (!cell.calDay) {
                    return (
                      ...
                      >
                        <span className="text-label text-muted-foreground/60">{cell.day}</span>
                      </div>
                    );
                  }
              ...
              {!compact && (data.bestDay || data.worstDay) && (
                <div className="flex items-center justify-center gap-3 mt-3">
                  {data.bestDay && (
                    <Badge
                      variant="outline"
                      className="text-label px-2 py-0.5 border-[var(--profit)]/30 text-[var(--profit)] gap-1"
                    >
                  ...
                  {data.worstDay && (
                    <Badge
                      variant="outline"
                      className="text-label px-2 py-0.5 border-[var(--loss)]/30 text-[var(--loss)] gap-1"
                    >
